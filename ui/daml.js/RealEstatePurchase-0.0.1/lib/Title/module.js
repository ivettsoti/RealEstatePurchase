...
var CityRecords = require('../CityRecords/module');
...
exports.NotifyCityClerk = {
  decoder: damlTypes.lazyMemo(function () { return jtv.object({cityClerk: damlTypes.Party.decoder, }); }),
  encode: function (__typed__) {
  return {
    cityClerk: damlTypes.Party.encode(__typed__.cityClerk),
  };
}
,
};
...
{
  templateId: 'ae8a7eeaf369df814f7aa2de7d5301fd55ef72c9ddd72dc44f8663372d319415:Title:Title',
...
,
  ...
  NotifyCityClerk: {
    ...
    resultDecoder: damlTypes.lazyMemo(function () { return damlTypes.ContractId(CityRecords.CityRecordNotification).decoder; }),
    resultEncode: function (__typed__) { return damlTypes.ContractId(CityRecords.CityRecordNotification).encode(__typed__); },
  },
}
